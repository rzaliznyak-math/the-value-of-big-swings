...
| Test Days (Min–Max) | Max Test N | Post-Test N | Baseline Conversion | Split |
|----------------------|------------|-------------|---------------------|-------|
...
- **Condition B (Treatment):** receives a sampled effect from the corresponding idea space.
...
The **Risk Threshold = 0.025%** was thoughtfully chosen in prior work as a balanced stopping point given the parameters of this experiment design.  
...
- Ten **Guaranteed Wins** are required to nearly match the value of an average **Big Swing** experiment.
- **Big Swing** experiments ran 33% faster on average.
