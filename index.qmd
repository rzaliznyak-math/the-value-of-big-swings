...
A/B testing isn’t just for testing hypotheses — it’s a tool for improving business outcomes like conversion, retention, and revenue. But in practice, experimentation forces a choice:

1. **Play it safe** with frequent, incremental wins  
2. **Swing big** with fewer, transformational tests that carry more risk — but potentially far greater upside

The question becomes: how should we allocate testing effort when traffic and time are limited?

This paper explores two competing strategies:

- **Guaranteed Small Wins** — 10 safe bets with low downside and small, consistent gains  
- **Transformational Tests** — a single high-variance bet with the potential to be a dud or a game-changer

Which delivers more value? Which uses users more efficiently?
...
Each strategy uses the same total user exposure (580k) per experiment. The goal is to assess which testing strategy delivers more value.
